...
def test_analyze(network_analysis, sample_data):
    ...
    assert set(result.keys()) == set(NetworkAnalysisResult.__annotations__.keys()), "Analyze output keys mismatch"
...
@pytest.mark.parametrize("data, expected_nodes, expected_edges", [
